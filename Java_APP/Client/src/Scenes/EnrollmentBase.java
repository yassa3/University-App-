...
public class EnrollmentBase extends AnchorPane {
    ...
    protected final Button enroll_btn;
    ...
    public EnrollmentBase() {
        ...
        enroll_btn.setLayoutX(461.0);
        enroll_btn.setLayoutY(714.0);
        enroll_btn.setMnemonicParsing(false);
        enroll_btn.setPrefHeight(45.0);
        enroll_btn.setPrefWidth(145.0);
        enroll_btn.setStyle("-fx-text-fill: black; -fx-border-color: black; -fx-cursor: hand; -fx-border-radius: 30; -fx-border-width: 2px; -fx-background-color: #ddcc9f; -fx-padding: 8; -fx-background-radius: 30; -fx-font-size: 17; -fx-font-weight: bold;");
        enroll_btn.setText("Enroll");
        enroll_btn.setTextAlignment(javafx.scene.text.TextAlignment.CENTER);
        enroll_btn.setTextOverrun(javafx.scene.control.OverrunStyle.CLIP);
