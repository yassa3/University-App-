...
public class DeleteDoctorCourseBase extends AnchorPane {
    ...
    public DeleteDoctorCourseBase() {
        ...
        delete_btn.setLayoutX(461.0);
        delete_btn.setLayoutY(714.0);
        delete_btn.setMnemonicParsing(false);
        delete_btn.setPrefHeight(45.0);
        delete_btn.setPrefWidth(145.0);
        delete_btn.setStyle("-fx-text-fill: black; -fx-border-color: black; -fx-cursor: hand; -fx-border-radius: 30; -fx-border-width: 2px; -fx-background-color: #ddcc9f; -fx-padding: 8; -fx-background-radius: 30; -fx-font-size: 17; -fx-font-weight: bold;");
