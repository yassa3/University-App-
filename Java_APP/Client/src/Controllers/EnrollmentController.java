...
public class EnrollmentController {
    ...
    public EnrollmentController(Stage s,EnrollmentBase eb){
        eb.getEnroll_btn().addEventHandler(ActionEvent.ACTION, new EventHandler<ActionEvent>() {
                    @Override
                    public void handle(ActionEvent event) {
                        ...
                        if (eb.getEmail_txt().isEmpty())
                            eb.setErr("Please Enter student email");
                        else {
                            eb.setErr("");
                        DtoHas has = new DtoHas(eb.getEmail_txt(),selectedCourse.getCourse_Code());
                        Gson gson = new Gson();
                        String json = gson.toJson(has);
                        JsonObject J_obj = new JsonObject();
                        J_obj.addProperty("key", "Enroll");
        ...
        eb.getShow_btn().addEventHandler(ActionEvent.ACTION, new EventHandler<ActionEvent>() {
                    @Override
                    public void handle(ActionEvent event) {
                        try {               
                        server = new Socket(IP, 5000);
                        mouth = new PrintStream(server.getOutputStream());
                        ear = new DataInputStream(server.getInputStream()); 
                        DtoStudent student = new DtoStudent(eb.getEmail_txt());
                        Gson gson = new Gson();
                        String json = gson.toJson(student);
                        JsonObject J_obj = new JsonObject();
                        J_obj.addProperty("key", "ShowEnroll");
                        J_obj.addProperty("value",json);
                        mouth.println(J_obj);
                        new Thread() {
                            public void run() {
                                        ...
                                        Platform.runLater(() -> {
                                            ...
                                            if ("R".equals(key)) {
                                                ...
                                                if (courses != null ){
                                                    ...
                                                    finalTableView_courses[0]=eb.getCourse_view();
                                                    finalTableColumnCourseCode[0]=eb.getCode_col();
                                                    finalTableColumnCourseName[0]=eb.getName_col();
                                                    finalTableColumnCourseSemester[0]=eb.getSemester_col();
                                                    finalTableColumnCourseHours[0]=eb.getHours_col();
                                                    finalTableColumnCourseDeptCode[0]=eb.getDept_code_col();
        ...
        eb.getStudents().addEventHandler(ActionEvent.ACTION, new EventHandler<ActionEvent>() {
                @Override
                public void handle(ActionEvent event) {
        ...
        eb.getDoctors().addEventHandler(ActionEvent.ACTION, new EventHandler<ActionEvent>() {
                @Override
                public void handle(ActionEvent event) {
                    SceneController sceneController = new SceneController(s);
                    try {
        ...
        eb.getCourses().addEventHandler(ActionEvent.ACTION, new EventHandler<ActionEvent>() {
                @Override
                public void handle(ActionEvent event) {
                    SceneController sceneController = new SceneController(s);
                    try {
        ...
        eb.getDepartments().addEventHandler(ActionEvent.ACTION, new EventHandler<ActionEvent>() {
                @Override
                public void handle(ActionEvent event) {
                    SceneController sceneController = new SceneController(s);
                    try {
